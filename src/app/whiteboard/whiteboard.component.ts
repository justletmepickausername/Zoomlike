...
export class WhiteboardComponent 
{
    ...
    ngOnInit()
	{
		...
		this.currentThickness = 8;
		this.currentSelectedColor = "black";
	...
	ToolClicked(tool: string, toolContainer: HTMLDivElement)
	{
		this.UnselectTools();
	...
	UnselectTools()
	{
		var text = document.getElementById("text-tool") as HTMLDivElement;
		var brush = document.getElementById("brush-tool") as HTMLDivElement;
		var pen = document.getElementById("pen-tool") as HTMLDivElement;
		var eraser = document.getElementById("eraser-tool") as HTMLDivElement;
		
		text.classList.remove('active-tool');
		brush.classList.remove('active-tool');
